...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fee4c966a549c001705cfdc
...
To start editing your site, you can use the Sanity interface at https://consubio-e4c96.sanity.studio/.
...
Generated at `2021-01-01T00:33:36.739Z` by Stackbit version `0.3.42`.